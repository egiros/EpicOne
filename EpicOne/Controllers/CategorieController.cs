...
namespace EpicOne.Controllers
{
    public class CategorieController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoriaID,Nome,Descrizione")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoriaID,Nome,Descrizione")] Categorie categorie)
        {
            if (ModelState.IsValid)
            {
